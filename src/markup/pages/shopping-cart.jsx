...
import { removeItem, addQuantity, subtractQuantity , resetCart } from '../../store/actions/cartActions';
                                        ...
                                        <table id="shopping-cart-table" class="data-table cart-table table-striped">
                                            ...
                                            <tfoot>
                                                <tr class="first last">
                                                    ...
                                                    <Link to={'/'}>  <button type="button" title="Continue Shopping"
                                                            class="button btn-continue" onClick=""><span><span>Continue
                                                            Shopping</span></span></button></Link>
                                                       
                                                        <button type="button" name="update_cart_action" value="empty_cart"
                                                            title="Clear Cart" class="button btn-empty"
                                                            id="empty_cart_button" onClick={()=>{this.handleresetCart()}}><span><span>Clear Cart</span></span></button>
                                                                     ...
                                                                     (this.props.products.map((data, idx) => {
                                                                            return (
                                                                                ...
                                                                                <td class="a-center hidden-table">
                                                                                    <Link href="#" class="edit-bnt" title={data.title}></Link>
                                                                                </td>
                                                                                ...
                                                                                <td class="a-center movewishlist">
                                                                                    ...
                                                                                    <input name="cart[26340][qty]" value={data.quantity} size="6" title="Qty" onChange={e => (e)}
                                                                                ...
                                                                                <td class="a-right movewishlist">
                                                                                    <span class="cart-price">
                                                                                        ...
                                                                                        <span class="price">{data.price * data.quantity} EGP</span>
                                                                                    </span>
                                                                                </td>
                                                ...
                                                <table id="shopping-cart-totals-table" class="table shopping-cart-table-total">
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td class="a-right">
                                                                <strong><span class="price">{this.props.total}</span></strong>
                                                            </td>
                                                        </tr>
                                                    </tfoot>
                                                    <tbody>
                                                        <tr>
                                                            <td class="a-left" colspan="1">
                                                                Subtotal </td>
                                                            <td class="a-right">
                                                                <span class="price">{this.props.total}</span> </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
