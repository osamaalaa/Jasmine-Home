                                    ...
                                    <nav>
                                        ...
                                        <div className="nav-inner">
                                            ...
                                            <ul id="nav"  className="hidden-xs">
                                                ...
                                                <li> <Link className="level-top" to={'/'}><span>About Us</span></Link></li>
                                                <li> <Link className="level-top" to={'/'}><span>Products</span></Link></li>
                                                <li> <Link className="level-top" to={'/'}><span>Contact Us</span></Link></li>
                                            </ul>
                                            {/* <!--nav--> */}
                                        </div>
                                    </nav>
